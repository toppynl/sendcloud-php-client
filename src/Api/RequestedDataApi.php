...
class RequestedDataApi
{
    ...
    {
        [$response] = $this->scPublicV3DsfGetRequestedDataWithHttpInfo();
        return $response;
    }
    ...
    public function scPublicV3DsfPostRequestedDataRequest($scPublicV3DsfPostRequestedDataRequest)
    {
        ...
        if ($scPublicV3DsfPostRequestedDataRequest === null || (is_array($scPublicV3DsfPostRequestedDataRequest) && $scPublicV3DsfPostRequestedDataRequest === [])) {
