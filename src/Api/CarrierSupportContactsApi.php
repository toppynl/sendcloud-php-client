...
class CarrierSupportContactsApi
{
    ...
    {
        list($response) = $this->scPublicV3DsfGetCarrierSupportContactsWithHttpInfo();
        return $response;
    }
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\CarrierSupportContact',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\CarrierSupportContact';
        $request = $this->scPublicV3DsfGetCarrierSupportContactsRequest();
    ...
    {
        list($response) = $this->scPublicV3DsfPatchCarrierSupportContactsWithHttpInfo($id, $patchSupportContactRequest);
        return $response;
    }
    ...
    public function scPublicV3DsfPatchCarrierSupportContactsRequest($id, $patchSupportContactRequest)
    {
        ...
        if ($patchSupportContactRequest === null || (is_array($patchSupportContactRequest) && count($patchSupportContactRequest) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->scPublicV3DsfPostCarrierSupportContactsWithHttpInfo($createSupportContactRequest);
        return $response;
    }
    ...
    public function scPublicV3DsfPostCarrierSupportContactsRequest($createSupportContactRequest)
    {
        ...
        if ($createSupportContactRequest === null || (is_array($createSupportContactRequest) && count($createSupportContactRequest) === 0)) {
            throw new \InvalidArgumentException(
