...
class OrdersApi
{
     ...
     *
     * @param  int $integration Filter orders by one or more integration IDs. Use a comma separated list, e.g. &#x60;integration&#x3D;41,68,419&#x60;.  You can get your integration IDs from the [Retrieve a list of integrations](/api/v3/integrations/retrieve-a-list-of-integrations) endpoint. (optional)
     * @param  string $orderNumber Filter orders by a specific order number, e.g. &#x60;order_number&#x3D;ORDER_284565&#x60;. The filtering is case insensitive. (optional)
     * @param  string $orderId Filter orders by a specific order id, e.g. &#x60;order_id&#x3D;1896e94b-c01b-4e73-a9e7-57f51c8a4c77&#x60;. The filtering is case insensitive. (optional)
     * @param  string $status Filter orders based on their status, e.g. &#x60;status&#x3D;unshipped&#x60;. The filtering is case insensitive. (optional)
     * @param  \DateTime $orderCreatedAt Find orders that were created on a specific date, e.g. &#x60;order_created_at&#x3D;2023-04-28&#x60;. (optional)
     * @param  \DateTime $orderCreatedAtMin Find orders that were created at or after a specific date, e.g. &#x60;order_created_at_min&#x3D;2023-04-28&#x60;. (optional)
     * @param  \DateTime $orderCreatedAtMax Find orders that were created at or before a specific date, e.g. &#x60;order_created_at_max&#x3D;2023-04-28&#x60;. (optional)
     * @param  \DateTime $orderUpdatedAt Find orders that were updated on a specific date, e.g. &#x60;order_updated_at&#x3D;2023-04-28&#x60;. (optional)
     * @param  \DateTime $orderUpdatedAtMin Find orders that were updated at or after a specific date, e.g. &#x60;order_updated_at_min&#x3D;2023-04-28&#x60;. (optional)
     * @param  \DateTime $orderUpdatedAtMax Find orders that were updated at or before a specific date, e.g. &#x60;order_updated_at_max&#x3D;2023-04-28&#x60;. (optional)
     * @param  string $sort Sort the orders in the response by using one or more of the following values:  - &#x60;integration&#x60;: Sort by the integration ID of the retrieved orders; to sort in descending order, use &#x60;-integration&#x60;  - &#x60;order_number&#x60;: Sort by the order number of the retrieved orders; to sort in descending order, use &#x60;-order_number&#x60;.  - &#x60;order_created_at&#x60;: Sort by the date of an order creation of the retrieved orders; to sort in descending order, use &#x60;-order_created_at&#x60;  - &#x60;order_updated_at&#x60;: Sort by the date of an order update of the retrieved orders; to sort in descending order, use &#x60;-order_updated_at&#x60;  - &#x60;pk&#x60;: Sort by the ID (autogenerated internal ID) of the retrieved orders; to sort in descending order, use &#x60;-pk&#x60;  Additional information about this query:  - Any valid combination of the above values is supported, e.g. &#x60;sort&#x3D;integration,-order_created_at&#x60;.   - In case of conflicting &#x60;sort&#x60; values, e.g. &#x60;/?sort&#x3D;integration,-integration&#x60;, the conflicting value will be ignored.  - If the &#x60;sort&#x60; query parameter is not set, the sorting of the retrieved orders will default to &#x60;-pk&#x60;.  - If an unsupported &#x60;sort&#x60; value is provided, the results will be sorted by the default (&#x60;-pk&#x60;). (optional)
    ...
    {
        [$response] = $this->scPublicV3OrdersGetListOrdersWithHttpInfo($integration, $orderNumber, $orderId, $status, $orderCreatedAt, $orderCreatedAtMin, $orderCreatedAtMax, $orderUpdatedAt, $orderUpdatedAtMin, $orderUpdatedAtMax, $sort, $pageSize, $cursor);
        return $response;
    }
    ...
    {
        [$response] = $this->scPublicV3OrdersPatchPartialUpdateOrderWithHttpInfo($id, $orderPartialUpdate);
        return $response;
    }
    ...
    {
        [$response] = $this->scPublicV3OrdersPostCreateOrdersWithHttpInfo($sendcloudPartnerId, $scPublicV3OrdersPostCreateOrdersRequestInner);
        return $response;
    }
