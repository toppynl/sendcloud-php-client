...
class ShipmentsApi
{
    ...
    {
        list($response) = $this->scPublicV3ScpGetAllShipmentsWithHttpInfo($parcelStatus, $trackingNumber, $externalReferenceId, $orderNumber, $integrationId, $updatedBefore, $updatedAfter, $announcedBefore, $announcedAfter, $ids, $cursor, $pageSize);
        return $response;
    }
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ScPublicV3ScpGetAllShipments200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\ScPublicV3ScpGetAllShipments200Response';
        $request = $this->scPublicV3ScpGetAllShipmentsRequest($parcelStatus, $trackingNumber, $externalReferenceId, $orderNumber, $integrationId, $updatedBefore, $updatedAfter, $announcedBefore, $announcedAfter, $ids, $cursor, $pageSize);
    ...
    public function scPublicV3ScpGetAllShipmentsRequest($parcelStatus = null, $trackingNumber = null, $externalReferenceId = null, $orderNumber = null, $integrationId = null, $updatedBefore = null, $updatedAfter = null, $announcedBefore = null, $announcedAfter = null, $ids = null, $cursor = null, $pageSize = 40)
    {
        ...
        if ($parcelStatus !== null) {
            if('form' === 'form' && is_array($parcelStatus)) {
        ...
        if ($externalReferenceId !== null) {
            if('form' === 'form' && is_array($externalReferenceId)) {
        ...
        if ($updatedBefore !== null) {
            if('form' === 'form' && is_array($updatedBefore)) {
        ...
        if ($updatedAfter !== null) {
            if('form' === 'form' && is_array($updatedAfter)) {
        ...
        if ($announcedBefore !== null) {
            if('form' === 'form' && is_array($announcedBefore)) {
        ...
        if ($announcedAfter !== null) {
            if('form' === 'form' && is_array($announcedAfter)) {
    ...
    {
        list($response) = $this->scPublicV3ScpGetShipmentByIdWithHttpInfo($id);
        return $response;
    }
    ...
    public function scPublicV3ScpGetShipmentByIdWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ScPublicV3ScpGetShipmentById200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\ScPublicV3ScpGetShipmentById200Response';
        $request = $this->scPublicV3ScpGetShipmentByIdRequest($id);
    ...
    {
        list($response) = $this->scPublicV3ScpPostAnnounceShipmentWithHttpInfo($sendcloudPartnerId, $shipmentRequestSyncAnnounce);
        return $response;
    }
    ...
    public function scPublicV3ScpPostAnnounceShipmentWithHttpInfo($sendcloudPartnerId = null, $shipmentRequestSyncAnnounce = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\AnnouncedShipmentIncludingLabel',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\AnnouncedShipmentIncludingLabel';
        $request = $this->scPublicV3ScpPostAnnounceShipmentRequest($sendcloudPartnerId, $shipmentRequestSyncAnnounce);
    ...
    {
        list($response) = $this->scPublicV3ScpPostAnnounceShipmentWithRulesWithHttpInfo($sendcloudPartnerId, $shipmentRequestWithRules);
        return $response;
    }
    ...
    {
        list($response) = $this->scPublicV3ScpPostCancelShipmentWithHttpInfo($id);
        return $response;
    }
    ...
    public function scPublicV3ScpPostCancelShipmentWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\CancelShipmentStatus',
                        $request,
                        $response,
                    );
                case 202:
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\CancelShipmentStatus';
        $request = $this->scPublicV3ScpPostCancelShipmentRequest($id);
    ...
    {
        list($response) = $this->scPublicV3ScpPostCreateShipmentWithHttpInfo($sendcloudPartnerId, $shipmentRequestAsync);
        return $response;
    }
    ...
    public function scPublicV3ScpPostCreateShipmentWithHttpInfo($sendcloudPartnerId = null, $shipmentRequestAsync = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ShipmentCreatedResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\ShipmentCreatedResponse';
        $request = $this->scPublicV3ScpPostCreateShipmentRequest($sendcloudPartnerId, $shipmentRequestAsync);
    ...
    {
        list($response) = $this->scPublicV3ScpPostCreateShipmentWithRulesWithHttpInfo($sendcloudPartnerId, $shipmentRequestWithRules);
        return $response;
    }
