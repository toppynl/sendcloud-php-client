...
class ShippingOptionsApi
{
    ...
    {
        list($response) = $this->scPublicV3ScpPostShippingOptionsWithHttpInfo($shippingOptionFilter);
        return $response;
    }
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ScPublicV3ScpPostShippingOptions200Response',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return Promise
     */
    public function scPublicV3ScpPostShippingOptionsAsync($shippingOptionFilter = null)
    {
        return $this->scPublicV3ScpPostShippingOptionsAsyncWithHttpInfo($shippingOptionFilter)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\ScPublicV3ScpPostShippingOptions200Response';
        $request = $this->scPublicV3ScpPostShippingOptionsRequest($shippingOptionFilter);
     ...
     */
    public function scPublicV3ScpPostShippingOptionsRequest($shippingOptionFilter = null)
    {

        $resourcePath = '/shipping-options';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = null;
        ...
        // for model (json/xml)
        if (isset($shippingOptionFilter)) {
            if ($this->headerSelector->isJsonMime($headers['Content-Type'])) {
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($shippingOptionFilter));
            } else {
                $httpBody = $shippingOptionFilter;
            }
    ...
    /**
     * Operation scPublicV3ScpPostShippingOptionsSimple
     *
    ...
    {
        list($response) = $this->scPublicV3ScpPostShippingOptionsSimpleWithHttpInfo($singleParcelShippingOptionFilter);
        return $response;
    }

    /**
     * Operation scPublicV3ScpPostShippingOptionsSimpleWithHttpInfo
     *
     * Create a list of shipping options
     *
     * @param  \Toppy\Sendcloud\Model\SingleParcelShippingOptionFilter $singleParcelShippingOptionFilter  (optional)
    ...
    public function scPublicV3ScpPostShippingOptionsSimpleWithHttpInfo($singleParcelShippingOptionFilter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ScPublicV3ScpPostShippingOptionsSimple200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation scPublicV3ScpPostShippingOptionsSimpleAsync
     *
     * Create a list of shipping options
     *
     * @param  \Toppy\Sendcloud\Model\SingleParcelShippingOptionFilter $singleParcelShippingOptionFilter  (optional)
     ...
     * @return Promise
     */
    public function scPublicV3ScpPostShippingOptionsSimpleAsync($singleParcelShippingOptionFilter = null)
    {
        return $this->scPublicV3ScpPostShippingOptionsSimpleAsyncWithHttpInfo($singleParcelShippingOptionFilter)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation scPublicV3ScpPostShippingOptionsSimpleAsyncWithHttpInfo
     *
     * Create a list of shipping options
     *
     * @param  \Toppy\Sendcloud\Model\SingleParcelShippingOptionFilter $singleParcelShippingOptionFilter  (optional)
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\ScPublicV3ScpPostShippingOptionsSimple200Response';
        $request = $this->scPublicV3ScpPostShippingOptionsSimpleRequest($singleParcelShippingOptionFilter);
     ...
     * @return RequestInterface
     */
    public function scPublicV3ScpPostShippingOptionsSimpleRequest($singleParcelShippingOptionFilter = null)
    {

        $resourcePath = '/fetch-shipping-options';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = null;
        ...
        // for model (json/xml)
        if (isset($singleParcelShippingOptionFilter)) {
            if ($this->headerSelector->isJsonMime($headers['Content-Type'])) {
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($singleParcelShippingOptionFilter));
            } else {
                $httpBody = $singleParcelShippingOptionFilter;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
