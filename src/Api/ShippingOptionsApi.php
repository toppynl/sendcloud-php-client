...
class ShippingOptionsApi
{
    ...
    {
        [$response] = $this->scPublicV3ScpPostShippingOptionsWithHttpInfo($shippingOptionFilter);
        return $response;
    }
    ...
    {
        [$response] = $this->scPublicV3ScpPostShippingOptionsSimpleWithHttpInfo($singleParcelShippingOptionFilter);
        return $response;
    }
