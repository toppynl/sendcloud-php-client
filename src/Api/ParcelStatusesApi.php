...
class ParcelStatusesApi
{
    ...
    /**
     * Operation scPublicV3ScpGetAllParcelStatuses
     *
    ...
    {
        list($response) = $this->scPublicV3ScpGetAllParcelStatusesWithHttpInfo();
        return $response;
    }

    /**
     * Operation scPublicV3ScpGetAllParcelStatusesWithHttpInfo
     *
     * Retrieve a list of all possible parcel statuses
     *
     *
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ScPublicV3ScpGetAllParcelStatuses200Response',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation scPublicV3ScpGetAllParcelStatusesAsync
     *
     * Retrieve a list of all possible parcel statuses
     *
     *
     ...
     * @return Promise
     */
    public function scPublicV3ScpGetAllParcelStatusesAsync()
    {
        return $this->scPublicV3ScpGetAllParcelStatusesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation scPublicV3ScpGetAllParcelStatusesAsyncWithHttpInfo
     *
     * Retrieve a list of all possible parcel statuses
     *
     *
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\ScPublicV3ScpGetAllParcelStatuses200Response';
        $request = $this->scPublicV3ScpGetAllParcelStatusesRequest();
    ...
    /**
     * Create request for operation 'scPublicV3ScpGetAllParcelStatuses'
     *
     *
     * @throws \InvalidArgumentException
     * @return RequestInterface
     */
    public function scPublicV3ScpGetAllParcelStatusesRequest()
    {

        $resourcePath = '/parcels/statuses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = null;
