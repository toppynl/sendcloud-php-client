...
class ReturnsApi
{
    ...
    {
        list($response) = $this->scPublicV3ScpGetReturnsGetDetailsWithHttpInfo($id);
        return $response;
    }
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ModelReturn',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\ModelReturn';
        $request = $this->scPublicV3ScpGetReturnsGetDetailsRequest($id);
    ...
    {
        list($response) = $this->scPublicV3ScpGetReturnsGetReturnsWithHttpInfo($fromDate, $toDate, $cursor, $parentParcelStatus, $pageSize);
        return $response;
    }
    ...
    public function scPublicV3ScpGetReturnsGetReturnsWithHttpInfo($fromDate, $toDate, $cursor = null, $parentParcelStatus = null, $pageSize = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ScPublicV3ScpGetReturnsGetReturns200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\ScPublicV3ScpGetReturnsGetReturns200Response';
        $request = $this->scPublicV3ScpGetReturnsGetReturnsRequest($fromDate, $toDate, $cursor, $parentParcelStatus, $pageSize);
    ...
    public function scPublicV3ScpGetReturnsGetReturnsRequest($fromDate, $toDate, $cursor = null, $parentParcelStatus = null, $pageSize = null)
    {
        ...
        if ($parentParcelStatus !== null) {
            if('form' === 'form' && is_array($parentParcelStatus)) {
    ...
    {
        list($response) = $this->scPublicV3ScpPatchReturnsCancelWithHttpInfo($id);
        return $response;
    }
    ...
    public function scPublicV3ScpPatchReturnsCancelWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ScPublicV3ScpPatchReturnsCancel202Response',
                        $request,
                        $response,
                    );
                case 409:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ScPublicV3ScpPatchReturnsCancel409Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\ScPublicV3ScpPatchReturnsCancel202Response';
        $request = $this->scPublicV3ScpPatchReturnsCancelRequest($id);
    ...
    {
        list($response) = $this->scPublicV3ScpPostReturnsCreateNewReturnWithHttpInfo($sendcloudPartnerId, $scPublicV3ScpPostReturnsCreateNewReturnRequest);
        return $response;
    }
    ...
    public function scPublicV3ScpPostReturnsCreateNewReturnWithHttpInfo($sendcloudPartnerId = null, $scPublicV3ScpPostReturnsCreateNewReturnRequest = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ScPublicV3ScpPostReturnsCreateNewReturn201Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\ScPublicV3ScpPostReturnsCreateNewReturn201Response';
        $request = $this->scPublicV3ScpPostReturnsCreateNewReturnRequest($sendcloudPartnerId, $scPublicV3ScpPostReturnsCreateNewReturnRequest);
    ...
    {
        list($response) = $this->scPublicV3ScpPostReturnsCreateNewReturnSynchronouslyWithHttpInfo($sendcloudPartnerId, $scPublicV3ScpPostReturnsCreateNewReturnRequest);
        return $response;
    }
    ...
    public function scPublicV3ScpPostReturnsCreateNewReturnSynchronouslyWithHttpInfo($sendcloudPartnerId = null, $scPublicV3ScpPostReturnsCreateNewReturnRequest = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ScPublicV3ScpPostReturnsCreateNewReturnSynchronously400Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        list($response) = $this->scPublicV3ScpPostReturnsValidateWithHttpInfo($sendcloudPartnerId, $scPublicV3ScpPostReturnsCreateNewReturnRequest);
        return $response;
    }
    ...
    public function scPublicV3ScpPostReturnsValidateWithHttpInfo($sendcloudPartnerId = null, $scPublicV3ScpPostReturnsCreateNewReturnRequest = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Toppy\Sendcloud\Model\ReturnValidation',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Toppy\Sendcloud\Model\ReturnValidation';
        $request = $this->scPublicV3ScpPostReturnsValidateRequest($sendcloudPartnerId, $scPublicV3ScpPostReturnsCreateNewReturnRequest);
