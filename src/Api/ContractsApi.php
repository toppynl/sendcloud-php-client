...
class ContractsApi
{
    ...
    {
        [$response] = $this->scPublicV3ScpGetAllContractsWithHttpInfo($carrierCode, $isActive, $clientId, $name, $countryCode, $cursor, $pageSize);
        return $response;
    }
    ...
    {
        [$response] = $this->scPublicV3ScpGetAllContractsSchemasWithHttpInfo($carrierCode);
        return $response;
    }
    ...
    {
        [$response] = $this->scPublicV3ScpGetSpecificContractWithHttpInfo($id);
        return $response;
    }
    ...
    {
        [$response] = $this->scPublicV3ScpPatchContractWithHttpInfo($id, $updateContractRequest);
        return $response;
    }
    ...
    {
        [$response] = $this->scPublicV3ScpPostCreateContractWithHttpInfo($createContractRequest);
        return $response;
    }
