...
class Configuration
{
     ...
     *
     * @return array<int, array<string, string>> an array of host settings
     */
     ...
     *
     * @param array<int, mixed> $hostSettings array of host settings, generated from getHostSettings() or equivalent from the API clients
