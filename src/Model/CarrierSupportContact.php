...
/**
 * CarrierSupportContact Class Doc Comment
 *
 * @category Class
 * @package  Toppy\Sendcloud
 * @author   OpenAPI Generator team
 ...
 */
class CarrierSupportContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CarrierSupportContact';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'carrierCode' => '\Toppy\Sendcloud\Model\CarrierCodeField',
        'email' => 'string',
        'language' => '\Toppy\Sendcloud\Model\CarrierLanguageField'
    ];
    ...
    */
     ...
     * Sets email
     *
     * @param string $email Email address of the carrier to which the ticket details will be forwarded.
     *
     * @return self
     */
