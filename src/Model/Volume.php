 ...
 */
class Volume implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function setValue($value)
    {
        ...
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling Volume., must be bigger than or equal to 0.');
        }
