 ...
 */
class FedexResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'fedex-response';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling FedexResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling FedexResponse., number of items must be greater than or equal to 1.');
        }
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling FedexResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setSpecialInstructions($specialInstructions)
    {
        ...
        if ((mb_strlen($specialInstructions) < 0)) {
            throw new \InvalidArgumentException('invalid length for $specialInstructions when calling FedexResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setTrackingNumber($trackingNumber)
    {
        ...
        if ((mb_strlen($trackingNumber) < 0)) {
            throw new \InvalidArgumentException('invalid length for $trackingNumber when calling FedexResponse., must be bigger than or equal to 0.');
        }
