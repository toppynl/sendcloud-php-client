 ...
 */
class CreateCustomStatusMapping implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create-custom-status-mapping';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['mapping']) > 4)) {
            $invalidProperties[] = "invalid value for 'mapping', number of items must be less than or equal to 4.";
        }

        if ((count($this->container['mapping']) < 4)) {
            $invalidProperties[] = "invalid value for 'mapping', number of items must be greater than or equal to 4.";
        }
     ...
     * Sets integrationId
     *
     * @param int $integrationId Sendcloud Integration ID.
     *
     * @return self
     */
    ...
    public function setMapping($mapping)
    {
        ...
        if ((count($mapping) > 4)) {
            throw new \InvalidArgumentException('invalid value for $mapping when calling CreateCustomStatusMapping., number of items must be less than or equal to 4.');
        }

        if ((count($mapping) < 4)) {
            throw new \InvalidArgumentException('invalid length for $mapping when calling CreateCustomStatusMapping., number of items must be greater than or equal to 4.');
        }
