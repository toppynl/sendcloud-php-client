...
/**
 * CreateAddressChangeTransactional Class Doc Comment
 *
 * @category Class
 * @package  Toppy\Sendcloud\V3
 * @author   OpenAPI Generator team
 ...
 */
class CreateAddressChangeTransactional implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAddressChangeTransactional';
     ...
     * Sets newAddress
     *
     * @param string|null $newAddress Foo
     *
     * @return self
     */
