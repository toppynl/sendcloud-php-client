 ...
 */
class ErrorOAuth2 implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     * Sets errorDebug
     *
     * @param string|null $errorDebug Error Debug Information  Only available in dev mode.
     *
     * @return self
     */
     ...
     * Sets errorHint
     *
     * @param string|null $errorHint Error Hint  Helps the user identify the error cause.
     *
     * @return self
     */
