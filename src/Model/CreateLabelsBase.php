...
/**
 * CreateLabelsBase Class Doc Comment
 *
 * @category Class
 * @package  Toppy\Sendcloud
 * @author   OpenAPI Generator team
 ...
 */
class CreateLabelsBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create-labels-base';
    ...
    */
    ...
    public function setBrandId($brandId)
    {
        ...
        if (($brandId < 1)) {
            throw new \InvalidArgumentException('invalid value for $brandId when calling CreateLabelsBase., must be bigger than or equal to 1.');
        }
