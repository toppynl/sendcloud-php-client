...
/**
 * DhlDePickupItem Class Doc Comment
 *
 * @category Class
 ...
 */
class DhlDePickupItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dhl-de-pickup-item';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling DhlDePickupItem., must be bigger than or equal to 1.');
        }
