...
/**
 * DhlParcelIberiaPickupRequest Class Doc Comment
 *
 * @category Class
 * @package  Toppy\Sendcloud
 * @author   OpenAPI Generator team
 ...
 */
class DhlParcelIberiaPickupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dhl-parcel-iberia-pickup-request';
    ...
    */
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling DhlParcelIberiaPickupRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling DhlParcelIberiaPickupRequest., must be bigger than or equal to 0.');
        }
