...
/**
 * LabelSyncAllOfLabelDetails Class Doc Comment
 *
 * @category Class
 * @package  Toppy\Sendcloud
 * @author   OpenAPI Generator team
 ...
 */
class LabelSyncAllOfLabelDetails implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'label_sync_allOf_label_details';
     ...
     * Sets file
     *
     * @param string|null $file The base64 representation of the label file.
     *
     * @return self
     */
