 ...
 */
class OrderPartialUpdateOrderDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'order_partial_update_order_details';
    ...
    protected static $openAPITypes = [
        'integration' => '\Toppy\Sendcloud\Model\OrderPartialUpdateOrderDetailsIntegration',
        'status' => '\Toppy\Sendcloud\Model\OrderPartialUpdateOrderDetailsStatus',
    ...
    */
     ...
     * Sets orderCreatedAt
     *
     * @param \DateTime|null $orderCreatedAt The date and time that the order was placed in the respective shop system in ISO 8601
     *
     * @return self
     */
