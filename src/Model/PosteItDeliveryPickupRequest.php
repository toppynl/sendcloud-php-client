...
/**
 * PosteItDeliveryPickupRequest Class Doc Comment
 *
 * @category Class
 * @package  Toppy\Sendcloud\V3
 * @author   OpenAPI Generator team
 ...
 */
class PosteItDeliveryPickupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'poste-it-delivery-pickup-request';
    ...
    */
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling PosteItDeliveryPickupRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling PosteItDeliveryPickupRequest., must be bigger than or equal to 0.');
        }
