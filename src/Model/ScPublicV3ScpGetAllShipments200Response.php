 ...
 */
class ScPublicV3ScpGetAllShipments200Response implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sc_public_v3_scp_get_all_shipments_200_response';
    ...
    public function setData($data)
    {
        ...
        if ((count($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ScPublicV3ScpGetAllShipments200Response., number of items must be greater than or equal to 1.');
        }
