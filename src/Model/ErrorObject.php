 ...
 */
class ErrorObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'links' => '\Toppy\Sendcloud\Model\ErrorObjectLinks',
        'status' => 'string',
        'code' => 'string',
        'title' => 'string',
        'detail' => 'string',
        'source' => '\Toppy\Sendcloud\Model\ErrorObjectSource',
        'meta' => 'object'
    ];
