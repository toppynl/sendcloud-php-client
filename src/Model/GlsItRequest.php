 ...
 */
class GlsItRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'gls-it-request';
    ...
    */
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling GlsItRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling GlsItRequest., must be bigger than or equal to 0.');
        }
