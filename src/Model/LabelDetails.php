 ...
 */
class LabelDetails implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'label-details';
     ...
     * Sets mimeType
     *
     * @param string|null $mimeType The format of the label
     *
     * @return self
     */
