 ...
 */
class GetCustomStatusMappingData implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_custom_status_mapping_data';
     ...
     * Sets integrationId
     *
     * @param int|null $integrationId Sendcloud Integration ID.
     *
     * @return self
     */
