...
/**
 * UpsPickupAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class UpsPickupAddress implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ups-pickup-address';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('isAlternateAddress', $data ?? [], false);
        $this->setIfExists('isResidential', $data ?? [], false);
    }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpsPickupAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling UpsPickupAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling UpsPickupAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling UpsPickupAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets phoneNumber
     *
     * @param string|null $phoneNumber Phone number of the contact person in the E.164 format.
     *
     * @return self
     */
     ...
     * Sets floor
     *
     * @param string|null $floor Floor of the pickup place.
     *
     * @return self
     */
     ...
     * Sets room
     *
     * @param string|null $room Room of the pickup place.
     *
     * @return self
     */
    ...
    public function setIsAlternateAddress($isAlternateAddress)
    {
        if (is_null($isAlternateAddress)) {
            throw new \InvalidArgumentException('non-nullable isAlternateAddress cannot be null');
        }
    ...
    public function setIsResidential($isResidential)
    {
        if (is_null($isResidential)) {
            throw new \InvalidArgumentException('non-nullable isResidential cannot be null');
        }
