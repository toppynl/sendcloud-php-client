...
/**
 * OrdersDimension Class Doc Comment
 *
 * @category Class
 ...
 */
class OrdersDimension implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orders-dimension';
    ...
    public function setLength($length)
    {
        ...
        if (($length < 0)) {
            throw new \InvalidArgumentException('invalid value for $length when calling OrdersDimension., must be bigger than or equal to 0.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 0)) {
            throw new \InvalidArgumentException('invalid value for $width when calling OrdersDimension., must be bigger than or equal to 0.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height < 0)) {
            throw new \InvalidArgumentException('invalid value for $height when calling OrdersDimension., must be bigger than or equal to 0.');
        }
