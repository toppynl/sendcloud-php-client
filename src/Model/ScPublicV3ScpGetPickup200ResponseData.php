...
/**
 * ScPublicV3ScpGetPickup200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  Toppy\Sendcloud\V3
 * @author   OpenAPI Generator team
 ...
 */
class ScPublicV3ScpGetPickup200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = 'carrierCode';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sc_public_v3_scp_get_pickup_200_response_data';
    ...
    protected static $openAPITypes = [
        ...
        'carrierCode' => 'string',
        'contractId' => 'int',
        'address' => '\Toppy\Sendcloud\V3\Model\PickupAddressPhoneNumberRequired',
        'id' => 'int',
        'trackingNumber' => 'string',
        'status' => 'string',
        'createdAt' => '\DateTime',
        'cancelledAt' => '\DateTime',
        'originDetail' => '\Toppy\Sendcloud\V3\Model\FedexOriginDetail'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['carrierCode'] = static::$openAPIModelName;
    }
    ...
    */
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling ScPublicV3ScpGetPickup200ResponseData., must be bigger than or equal to 0.');
        }
    ...
    public function setSpecialInstructions($specialInstructions)
    {
        ...
        if ((mb_strlen($specialInstructions) < 0)) {
            throw new \InvalidArgumentException('invalid length for $specialInstructions when calling ScPublicV3ScpGetPickup200ResponseData., must be bigger than or equal to 0.');
        }
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ScPublicV3ScpGetPickup200ResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setTrackingNumber($trackingNumber)
    {
        ...
        if ((mb_strlen($trackingNumber) < 0)) {
            throw new \InvalidArgumentException('invalid length for $trackingNumber when calling ScPublicV3ScpGetPickup200ResponseData., must be bigger than or equal to 0.');
        }
