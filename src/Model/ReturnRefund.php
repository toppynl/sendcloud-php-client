 ...
 *
 * @category Class
 * @description Information about the compensation chosen by the customer for the returned items
 * @package  Toppy\Sendcloud
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ReturnRefund implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'return-refund';
    ...
    public const REFUND_TYPE_CREDIT = 'credit';
    public const REFUND_TYPE_EXCHANGE = 'exchange';
    ...
    public function getRefundTypeAllowableValues()
    {
        return [
            ...
            self::REFUND_TYPE_CREDIT,
            self::REFUND_TYPE_EXCHANGE,
        ];
    }
    ...
    */
     ...
     * Sets refundType
     *
     * @param string|null $refundType Identifier of the refund type
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Additional information about the refund provided by the end consumer
     *
     * @return self
     */
