...
/**
 * PostShopOrderStatusesStatusesInner
 *
 * PHP version 8.1
 *
 * @category Class
 ...
 */
class PostShopOrderStatusesStatusesInner implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_shop_order_statuses_statuses_inner';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['translations']) > 7)) {
            $invalidProperties[] = "invalid value for 'translations', number of items must be less than or equal to 7.";
        }

        if ((count($this->container['translations']) < 1)) {
     ...
     * Sets externalId
     *
     * @param string $externalId ID linked to the order status inside the integrated webshop.
     *
     * @return self
     */
    ...
    public function setTranslations($translations)
    {
        ...
        if ((count($translations) > 7)) {
            throw new \InvalidArgumentException('invalid value for $translations when calling PostShopOrderStatusesStatusesInner., number of items must be less than or equal to 7.');
        }

        if ((count($translations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $translations when calling PostShopOrderStatusesStatusesInner., number of items must be greater than or equal to 1.');
        }
