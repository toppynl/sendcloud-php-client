 ...
 */
class ScPublicV3DsfPostRequestedDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sc_public_v3_dsf_post_requested_data_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('salesData', $data ?? [], null);
    }
    ...
    {
        if (is_null($comment)) {
            $this->openAPINullablesSetToNull[] = 'comment';
        } else {
    ...
    {
        return $this->container['salesData'];
    }
    ...
    {
        if (is_null($salesData)) {
            throw new \InvalidArgumentException('non-nullable salesData cannot be null');
        }

        $this->container['salesData'] = $salesData;
