 ...
 */
class OAuth2TokenExchange implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     * Sets idToken
     *
     * @param string|null $idToken To retrieve a refresh token request the id_token scope.
     *
     * @return self
     */
