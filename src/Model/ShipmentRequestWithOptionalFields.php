 ...
 */
class ShipmentRequestWithOptionalFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment-request-with-optional-fields';
