 ...
 */
class ScPublicV3OrdersPostCreateOrdersRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sc_public_v3_orders_post_create_orders_request_inner';
    ...
    protected static $openAPITypes = [
        ...
        'customsDetails' => '\Toppy\Sendcloud\V3\Model\CustomsDetails',
        'customerDetails' => '\Toppy\Sendcloud\V3\Model\CustomerDetails',
        'billingAddress' => '\Toppy\Sendcloud\V3\Model\Address',
        'shippingAddress' => '\Toppy\Sendcloud\V3\Model\Address',
        'shippingDetails' => '\Toppy\Sendcloud\V3\Model\ShippingDetails',
        'servicePointDetails' => '\Toppy\Sendcloud\V3\Model\ServicePoint'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['orderNumber']) < 1)) {
    ...
    public function setOrderId($orderId)
    {
        ...
        if ((mb_strlen($orderId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling ScPublicV3OrdersPostCreateOrdersRequestInner., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNumber($orderNumber)
    {
        ...
        if ((mb_strlen($orderNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderNumber when calling ScPublicV3OrdersPostCreateOrdersRequestInner., must be bigger than or equal to 1.');
        }
     ...
     * Gets orderDetails
     *
     * @return \Toppy\Sendcloud\V3\Model\OrdersOrderOrderDetails
     */
     ...
     * Sets orderDetails
     *
     * @param \Toppy\Sendcloud\V3\Model\OrdersOrderOrderDetails $orderDetails orderDetails
     *
     * @return self
     */
