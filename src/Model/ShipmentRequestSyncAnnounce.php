...
/**
 * ShipmentRequestSyncAnnounce Class Doc Comment
 *
 * @category Class
 * @description Synchronous Announcement Shipment request object model
 * @package  Toppy\Sendcloud
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ShipmentRequestSyncAnnounce implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment-request-sync-announce';
    ...
    protected static $openAPITypes = [
        ...
        'customsInformation' => '\Toppy\Sendcloud\Model\CustomsInformation',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['parcels']) && (count($this->container['parcels']) > 15)) {
            $invalidProperties[] = "invalid value for 'parcels', number of items must be less than or equal to 15.";
        }
    ...
    public function setParcels($parcels)
    {
        ...
        if ((count($parcels) > 15)) {
            throw new \InvalidArgumentException('invalid value for $parcels when calling ShipmentRequestSyncAnnounce., number of items must be less than or equal to 15.');
        }
        if ((count($parcels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parcels when calling ShipmentRequestSyncAnnounce., number of items must be greater than or equal to 1.');
        }
