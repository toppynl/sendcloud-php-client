...
class ShipmentRequestSyncAnnounce implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets parcels
     *
     * @param \Toppy\Sendcloud\V3\Model\ParcelCommon[]|null $parcels Represents each package of the shipment. Note that you can send a maximum of 15 parcels per shipment to this endpoint.  To announce more than 15 parcels in the same shipment, you can use the [Create and announce a shipment asynchronously](/api/v3/shipments/create-and-announce-a-shipment-asynchronously) endpoint.  Note: each carrier can have a lower than the default number of parcels limit per shipment.
     *
     * @return self
     */
