...
/**
 * PickupAddressStateProvinceRequired Class Doc Comment
 *
 * @category Class
 ...
 */
class PickupAddressStateProvinceRequired implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pickup-address-state-province-required';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['stateProvinceCode'] === null) {
            $invalidProperties[] = "'stateProvinceCode' can't be null";
        }

        if ((mb_strlen((string) $this->container['stateProvinceCode']) < 1)) {
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PickupAddressStateProvinceRequired., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling PickupAddressStateProvinceRequired., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PickupAddressStateProvinceRequired., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $stateProvinceCode State code of the pickup place according to ISO 3166-2.
     *
     * @return self
     */
    public function setStateProvinceCode($stateProvinceCode)
    {
        ...
        if ((mb_strlen($stateProvinceCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling PickupAddressStateProvinceRequired., must be bigger than or equal to 1.');
        }
     ...
     * Sets countryCode
     *
     * @param string $countryCode Country code of the pickup place according to ISO 3166-1 alpha-2.
     *
     * @return self
     */
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling PickupAddressStateProvinceRequired., must be bigger than or equal to 1.');
        }
