...
/**
 * TrackingNumberCreateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TrackingNumberCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tracking-number-create-request';
    ...
    */
    ...
    public function setTrackingIdentifier($trackingIdentifier)
    {
        ...
        if ((mb_strlen($trackingIdentifier) > 255)) {
            throw new \InvalidArgumentException('invalid length for $trackingIdentifier when calling TrackingNumberCreateRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($trackingIdentifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $trackingIdentifier when calling TrackingNumberCreateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTrackingNumber($trackingNumber)
    {
        ...
        if ((mb_strlen($trackingNumber) > 255)) {
            throw new \InvalidArgumentException('invalid length for $trackingNumber when calling TrackingNumberCreateRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($trackingNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $trackingNumber when calling TrackingNumberCreateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTrackingUrl($trackingUrl)
    {
        ...
        if ((mb_strlen($trackingUrl) < 1)) {
            throw new \InvalidArgumentException('invalid length for $trackingUrl when calling TrackingNumberCreateRequest., must be bigger than or equal to 1.');
        }
