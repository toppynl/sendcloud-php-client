 ...
 */
class OrdersOrder implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orders-order';
    ...
    protected static $openAPITypes = [
        ...
        'createdAt' => '\DateTime',
        'modifiedAt' => '\DateTime',
        'orderDetails' => \Toppy\Sendcloud\V3\Model\OrdersOrderOrderDetails::class,
    ...
    public function setOrderId($orderId)
    {
        ...
        if ((mb_strlen($orderId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling OrdersOrder., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderNumber($orderNumber)
    {
        ...
        if ((mb_strlen($orderNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderNumber when calling OrdersOrder., must be bigger than or equal to 1.');
        }
