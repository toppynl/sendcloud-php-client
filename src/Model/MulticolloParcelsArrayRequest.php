 ...
 */
class MulticolloParcelsArrayRequest implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'multicollo-parcels-array-request';
    ...
    public function setParcels($parcels)
    {
        ...
        if ((count($parcels) > 50)) {
            throw new \InvalidArgumentException('invalid value for $parcels when calling MulticolloParcelsArrayRequest., number of items must be less than or equal to 50.');
        }

        if ((count($parcels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parcels when calling MulticolloParcelsArrayRequest., number of items must be greater than or equal to 1.');
        }
