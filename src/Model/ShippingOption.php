...
class ShippingOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'name' => 'string',
        'carrier' => '\Toppy\Sendcloud\Model\Carrier',
        'product' => '\Toppy\Sendcloud\Model\ShippingProduct',
        'functionalities' => '\Toppy\Sendcloud\Model\CarrierShippingFunctionalities',
        'maxDimensions' => '\Toppy\Sendcloud\Model\Dimension',
        'weight' => '\Toppy\Sendcloud\Model\ShippingQuoteWeight',
        'parcelBilledWeights' => '\Toppy\Sendcloud\Model\ParcelBilledWeights[]',
        'contract' => '\Toppy\Sendcloud\Model\Contract',
        'requirements' => '\Toppy\Sendcloud\Model\Requirements',
        'chargingType' => 'string',
