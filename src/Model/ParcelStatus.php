 ...
 */
class ParcelStatus implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     * Sets code
     *
     * @param string|null $code Unique code identifier
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ParcelStatus., must be bigger than or equal to 1.');
        }
     ...
     * Sets message
     *
     * @param string|null $message Friendly description
     *
     * @return self
     */
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling ParcelStatus., must be bigger than or equal to 1.');
        }
