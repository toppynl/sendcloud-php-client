 ...
 */
class Documents implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'documents';
    ...
    public const TYPE_AIR_WAYBILL = 'air-waybill';
     ...
     * Sets type
     *
     * @param string|null $type The type of the document. See the list below for available types.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param string|null $size The paper size of the document.
     *
     * @return self
     */
