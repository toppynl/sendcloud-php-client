 ...
 */
class ContractSchema implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'contract-schema';
     ...
     * Sets carrierCode
     *
     * @param string $carrierCode The carrier of the contract schema
     *
     * @return self
     */
