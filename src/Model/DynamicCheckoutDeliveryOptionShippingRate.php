...
/**
 * DynamicCheckoutDeliveryOptionShippingRate Class Doc Comment
 *
 * @category Class
 ...
 */
class DynamicCheckoutDeliveryOptionShippingRate implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dynamic_checkout_delivery_option_shipping_rate';
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling DynamicCheckoutDeliveryOptionShippingRate., must be bigger than or equal to 1.');
        }
