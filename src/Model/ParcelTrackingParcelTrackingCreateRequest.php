...
/**
 * ParcelTrackingParcelTrackingCreateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ParcelTrackingParcelTrackingCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'parcel-tracking-parcel-tracking-create-request';
    ...
    protected static $openAPITypes = [
        ...
        'details' => '\Toppy\Sendcloud\V3\Model\ParcelDetailCreateRequest',
        'fromAddress' => '\Toppy\Sendcloud\V3\Model\ParcelTrackingAddress',
        'insurance' => '\Toppy\Sendcloud\V3\Model\Insurance',
        'parcelItems' => '\Toppy\Sendcloud\V3\Model\ParcelItem[]',
        'measurements' => '\Toppy\Sendcloud\V3\Model\Measurement',
        'returnPrice' => '\Toppy\Sendcloud\V3\Model\OptionalPrice',
        'shipWith' => '\Toppy\Sendcloud\V3\Model\ParcelTrackingShipWith',
        'shipment' => '\Toppy\Sendcloud\V3\Model\ShipmentCreateRequest',
        'sourceId' => 'string',
        'toAddress' => '\Toppy\Sendcloud\V3\Model\ParcelTrackingAddress',
        'trackingNumber' => '\Toppy\Sendcloud\V3\Model\TrackingNumberCreateRequest'
    ];
    ...
    */
    ...
    public function setReturnPrice($returnPrice)
    {
        if (is_null($returnPrice)) {
            array_push($this->openAPINullablesSetToNull, 'returnPrice');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('returnPrice', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets shipWith
     *
     * @return \Toppy\Sendcloud\V3\Model\ParcelTrackingShipWith
     */
     ...
     * Sets shipWith
     *
     * @param \Toppy\Sendcloud\V3\Model\ParcelTrackingShipWith $shipWith shipWith
     *
     * @return self
     */
