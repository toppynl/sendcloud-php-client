...
class InlineObject implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    protected static $openAPITypes = [
        'data' => \Toppy\Sendcloud\V3\Model\InlineObjectData::class
    ];
     ...
     * Gets data
     *
     * @return \Toppy\Sendcloud\V3\Model\InlineObjectData|null
     */
     ...
     * Sets data
     *
     * @param \Toppy\Sendcloud\V3\Model\InlineObjectData|null $data data
     *
     * @return self
     */
