...
/**
 * DpdAtPickupItem Class Doc Comment
 *
 * @category Class
 ...
 */
class DpdAtPickupItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dpd-at-pickup-item';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling DpdAtPickupItem., must be bigger than or equal to 1.');
        }
