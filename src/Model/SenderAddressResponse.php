 ...
 */
class SenderAddressResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SenderAddressResponse';
    ...
    protected static $openAPITypes = [
        ...
        'phoneNumber' => 'string',
        'id' => 'int',
        'signature' => '\Toppy\Sendcloud\V3\Model\SenderAddressResponseAllOfSignature',
        'taxNumbers' => '\Toppy\Sendcloud\V3\Model\SenderAddressesTaxNumber[]'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SenderAddressResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets postalCode
     *
     * @param string|null $postalCode Zip code of the address
     *
     * @return self
     */
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling SenderAddressResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SenderAddressResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets countryCode
     *
     * @param string|null $countryCode The country code of the customer represented as ISO 3166-1 alpha-2
     *
     * @return self
     */
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling SenderAddressResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets id
     *
     * @param int|null $id The identifier for this Sender Address
     *
     * @return self
     */
     ...
     * Gets taxNumbers
     *
     * @return \Toppy\Sendcloud\V3\Model\SenderAddressesTaxNumber[]|null
     */
     ...
     * Sets taxNumbers
     *
     * @param \Toppy\Sendcloud\V3\Model\SenderAddressesTaxNumber[]|null $taxNumbers taxNumbers
     *
     * @return self
     */
