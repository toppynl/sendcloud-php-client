 ...
 */
class ScPublicV3DsfPostRequestedDataRequestSalesDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sc_public_v3_dsf_post_requested_data_request_sales_data_inner';
    ...
    protected static $openAPITypes = [
        ...
        'quantity' => 'int',
        'sellingPrice' => 'float',
        'currency' => '\Toppy\Sendcloud\V3\Model\CurrencyType',
        'taxRate' => 'float'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sellingPrice', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sellingPrice'] === null) {
            $invalidProperties[] = "'sellingPrice' can't be null";
        }
     ...
     * Sets sellingPrice
     *
     * @param float $sellingPrice Price per product item
     *
     * @return self
     */
    public function setSellingPrice($sellingPrice)
    {
        if (is_null($sellingPrice)) {
            throw new \InvalidArgumentException('non-nullable sellingPrice cannot be null');
        }
     ...
     * Sets taxRate
     *
     * @param float $taxRate Tax rate for the product
     *
     * @return self
     */
