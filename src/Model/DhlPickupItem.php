...
/**
 * DhlPickupItem Class Doc Comment
 *
 * @category Class
 ...
 */
class DhlPickupItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dhl-pickup-item';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling DhlPickupItem., must be bigger than or equal to 1.');
        }
