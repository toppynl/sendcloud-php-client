 ...
 */
class CustomerDetails implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customer-details';
     ...
     * Sets phoneNumber
     *
     * @param string|null $phoneNumber Phone number of the customer
     *
     * @return self
     */
