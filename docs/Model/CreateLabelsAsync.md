...
**shipWith** | [**\Toppy\Sendcloud\V3\Model\ShipAnOrderShipWith**](.md) |  | [optional]
**orders** | [**\Toppy\Sendcloud\V3\Model\CreateLabelsAsyncAllOfOrders[]**](CreateLabelsAsyncAllOfOrders.md) | Array of order objects you want to create labels for |
