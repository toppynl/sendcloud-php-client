...
**statusHistory** | [**\Toppy\Sendcloud\V3\Model\DetailedTrackingBlobStatus[]**](DetailedTrackingBlobStatus.md) | List with the timeline of your return status |
...
**reason** | [**\Toppy\Sendcloud\V3\Model\ReturnReason**](ReturnReason.md) |  | [optional]
**refund** | [**\Toppy\Sendcloud\V3\Model\ReturnRefund**](.md) |  | [optional]
**returnFee** | [**\Toppy\Sendcloud\V3\Model\PriceWithAnyCurrency**](.md) |  | [optional]
...
**errors** | [**\Toppy\Sendcloud\V3\Model\ErrorObject[]**](ErrorObject.md) | This array will contain errors such as carrier announcement errors. | [optional] [readonly]
