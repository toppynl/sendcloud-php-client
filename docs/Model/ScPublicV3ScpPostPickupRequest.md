...
------------ | ------------- | ------------- | -------------
**timeSlots** | [**\ToppySendcloudV3ModelTimeSlotEndAtRequired[]**](TimeSlotEndAtRequired.md) | Scheduled time slots for the pickup. Note that most carriers only support a single time slot. |
...
**originDetail** | [**\Toppy\Sendcloud\V3\Model\FedexOriginDetail**](FedexOriginDetail.md) |  |
