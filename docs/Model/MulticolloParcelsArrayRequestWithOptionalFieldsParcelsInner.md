# # MulticolloParcelsArrayRequestWithOptionalFieldsParcelsInner
...
**parcelItems** | [**\Toppy\Sendcloud\V3\Model\ParcelItemWithOptionalFields[]**](ParcelItemWithOptionalFields.md) | List of items/products that the parcel contains. **Note that parcel items array is required for shipments that require customs documents.** | [optional]
