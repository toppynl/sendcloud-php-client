...
------------ | ------------- | ------------- | -------------
**integration** | [**\Toppy\Sendcloud\Model\OrderOrderDetailsIntegration**](OrderOrderDetailsIntegration.md) |  |
**status** | [**\Toppy\Sendcloud\Model\OrderOrderDetailsStatus**](OrderOrderDetailsStatus.md) |  |
...
**orderItems** | [**\Toppy\Sendcloud\Model\OrderItemsInner[]**](OrderItemsInner.md) | The list of items that an order contains |
